	...
	public Student() {
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String query = "INSERT INTO `students`(`id`,`st_name`, `email`, `address`, `phone`, `GPA`) VALUES (?, ?, ?, ?,?,?)";
					con = DriverManager.getConnection("jdbc:mysql://localhost:3306/quanlydiem", "root", "Phenikaa23@@@");
					...
					if(id.getText().equals("") ||name.getText().equals("") || email.getText().equals("") || address.getText().equals("") || phone.getText().equals("")|| gpa.getText().equals("")) {
